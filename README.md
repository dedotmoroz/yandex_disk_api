...
5. Компонент App обнаруживает записанный cookie и отображает компонент YandexDisk, который строит дерево файлов Яндекс диска с помощью запросов к API Диска.
